...
### Compatibility
At the moment this mod is brand new and is only avaliable for a few versions, but I plan to extend support to other versions of the game in the future. This mod is also currently exclusive to the Fabric mod loader, but I'm working on a NeoForge version, so stay tuned for that!
